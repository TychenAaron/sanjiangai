...
async function main() {
  ...
  await mustContain("../app/api/documents/upload/route.ts", ["getBatchContext", "recordKnowledgeImportItem", "automaticallyApproved", "indexApprovedDocumentVersion", "同名同大小的已入库文件，已跳过重复上传"]);
